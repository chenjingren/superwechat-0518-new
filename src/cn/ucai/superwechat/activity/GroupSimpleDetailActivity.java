...
public class GroupSimpleDetailActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		groupInfo = (Group) getIntent().getSerializableExtra("groupinfo");
...
//		getResources().getString(R.string)
     ...
     private void showGroupDetail() {
		 ...
		 if(!SuperWeChatApplication.getInstance().getGroupList().contains(groupInfo))
			 btn_add_group.setEnabled(true);

         tv_name.setText(groupInfo.getMGroupName());
         tv_admin.setText(groupInfo.getMGroupOwner());
         tv_introduction.setText(groupInfo.getMGroupDescription());
