...
public class ChatAllHistoryFragment extends Fragment implements View.OnClickListener {
	...
	ContactListChangedReceiver mContactListChangedReceiver;
	...
	private void registerContactListChangedReceiver (){
		...
		IntentFilter filterGroup = new IntentFilter("update_group_list");
		getActivity().registerReceiver(mContactListChangedReceiver,filterGroup);
